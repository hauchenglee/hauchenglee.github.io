...
![](https://www.hauchenglee.com/assets/images/algorithms/rbt-z's-relationship.png)
...
2. Insert new leaf node as **<span style="color:red">red</span>**
   1. If parent is black:
      1. then done
   2. If parent is red:
      1. if **black** or empty sibling: rotate, recolor and done
      2. if **<span style="color:red">red</span>** sibling: recolor (parent and sibling and grandparent node (if grandparent node is not root: recolor)) and check again
...
strategy:
- z is root: recolor
- z uncle is **<span style="color:red">red</span>**: recolor (parent and sibling and grandparent node) and check again
...
Ref: [interview/RedBlackTree.java at master · mission-peace/interview](https://github.com/mission-peace/interview/blob/master/src/com/interview/tree/RedBlackTree.java){:target="_blank"}
