...
- 持续输入 → 过滤 → 吸收 → 结合其他资讯 → 精简 → 内化 → 沉淀与酝酿 → 选择表达方式 → 产出
- 不断复盘，深度地自我对话，找到背后真正原因，进行自我迭代更新
...
[Product Manager \| 吹雪](https://hauchenglee.github.io/course/2023/02/20/product-manager.html)
