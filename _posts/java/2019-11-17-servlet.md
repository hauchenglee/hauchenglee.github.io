...
標準的Java程式，可以在服務器端的[Web Container](https://www.hauchenglee.com/web-app-server-compare/)所提供的環境內執行。
...
Servlet容器是[Web Container](https://www.hauchenglee.com/web-app-server-compare/)和Servlet進行通訊的主要構件，它的主要職責包括：
- 管理Servlet程序的生命週期
...
- 路徑關聯: [Web App Server Path](https://www.hauchenglee.com/web-app-server-path/)
