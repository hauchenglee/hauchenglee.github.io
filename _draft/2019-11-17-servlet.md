...
標準的Java程式，可以在服務器端的Web Container所提供的環境內執行。
...
![](http://www.hauchenglee.com/assets/images/tech/tianmaying-servlet-container.png)

Servlet容器是Web服務器和Servlet進行通訊的主要構件，它的主要職責包括：
- 管理Servlet程序的生命週期
...
![](http://www.hauchenglee.com/assets/images/tech/tianmaying-httpservlet.png)
